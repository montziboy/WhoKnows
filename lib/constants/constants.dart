...
class AppConstants {
  // TEXT
  static const String title = 'WhoKnows';
  static const List<String> eula = [
  ...
  // COLORS
  static const Color backgroundColor1 = Color(0xFF455A64);
  static const Color backgroundColor2 = Color(0x90455A64);
}
